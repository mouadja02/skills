...
A curated collection of **830 Agent Skills** across **36 categories** for Claude Code, Cursor, and other clients that discover `SKILL.md` files recursively.
...
| [`api-backend`](./skills/api-backend/) | 14 | API design, backend implementation, OpenAPI, TypeSpec, FastAPI, and integrations. |
