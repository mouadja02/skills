...
A curated collection of **822 Agent Skills** across **36 categories** for Claude Code, Cursor, and other clients that discover `SKILL.md` files recursively.
...
| [`dev-workflow`](./skills/dev-workflow/) | 33 | Git, GitHub, CLI tooling, release workflows, local automation, and developer productivity. |
