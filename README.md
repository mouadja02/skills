...
A curated collection of **818 Agent Skills** across **36 categories** for Claude Code, Cursor, and other clients that discover `SKILL.md` files recursively.
...
| [`api-backend`](./skills/api-backend/) | 24 | API design, backend implementation, OpenAPI, TypeSpec, FastAPI, and integrations. |
...
| [`dev-workflow`](./skills/dev-workflow/) | 32 | Git, GitHub, CLI tooling, release workflows, local automation, and developer productivity. |
...
| [`engineering-craft`](./skills/engineering-craft/) | 36 | Senior engineering practices, planning, mentoring, verification, and cross-cutting craft. |
...
| [`marketing-and-growth`](./skills/marketing-and-growth/) | 27 | Marketing strategy, content, acquisition, SEO, CRO, and lifecycle growth. |
