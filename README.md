...
A curated collection of **823 Agent Skills** across **36 categories** for Claude Code, Cursor, and other clients that discover `SKILL.md` files recursively.
...
| [`dev-workflow`](./skills/dev-workflow/) | 34 | Git, GitHub, CLI tooling, release workflows, local automation, and developer productivity. |
