...
Data file: $SKILLS_HOME/personal-productivity/memento-flashcards/data/cards.json
or $HERMES_HOME/skills/productivity/memento-flashcards/data/cards.json for
...
if "MEMENTO_CARDS_FILE" in os.environ:
    CARDS_FILE = Path(os.environ["MEMENTO_CARDS_FILE"]).expanduser()
    DATA_DIR = CARDS_FILE.parent
else:
    _SKILLS_HOME = Path(os.environ.get("SKILLS_HOME", Path.home() / ".skills"))
    _HERMES_HOME = Path(os.environ.get("HERMES_HOME", Path.home() / ".hermes"))
    if "SKILLS_HOME" in os.environ or "HERMES_HOME" not in os.environ:
        DATA_DIR = _SKILLS_HOME / "personal-productivity" / "memento-flashcards" / "data"
    else:
