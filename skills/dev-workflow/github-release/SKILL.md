...
2–4 are read-only reconnaissance. No release branch or release content is created
...
### Step 1 — Ensure the default branch is up to date
...
- `references/evaluations.md` — Routing prompts and deterministic regression assertions
