...
| [`api-backend`](./api-backend/) | 28 | API design, backend implementation, OpenAPI, TypeSpec, FastAPI, and integrations. |
...
| [`dev-workflow`](./dev-workflow/) | 33 | Git, GitHub, CLI tooling, release workflows, local automation, and developer productivity. |
