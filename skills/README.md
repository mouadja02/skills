...
| [`api-backend`](./api-backend/) | 24 | API design, backend implementation, OpenAPI, TypeSpec, FastAPI, and integrations. |
...
| [`dev-workflow`](./dev-workflow/) | 32 | Git, GitHub, CLI tooling, release workflows, local automation, and developer productivity. |
...
| [`marketing-and-growth`](./marketing-and-growth/) | 27 | Marketing strategy, content, acquisition, SEO, CRO, and lifecycle growth. |
...
| [`personal-productivity`](./personal-productivity/) | 10 | Personal productivity, reminders, communication, notes, and connected tools. |
| [`product-management`](./product-management/) | 29 | Product discovery, specifications, delivery planning, analytics, and agile workflows. |
| [`prompting`](./prompting/) | 15 | Prompt engineering, optimization, safety review, and creative-thinking frameworks. |
| [`react-frontend`](./react-frontend/) | 17 | React, Vue, Next.js, mobile frontend frameworks, migrations, and testing. |
| [`research`](./research/) | 1 | Research workflows, public-record investigation, source collection, and evidence synthesis. |
| [`skills-management`](./skills-management/) | 13 | Skill authoring, discovery, cleanup, Copilot configuration, and terse interaction modes. |
| [`streamlit`](./streamlit/) | 18 | Streamlit applications, dashboards, chat UIs, components, layouts, and performance. |
| [`testing`](./testing/) | 12 | Testing, QA, Playwright, pytest, debugging, and evaluation strategy. |
