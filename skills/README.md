...
| [`api-backend`](./api-backend/) | 29 | API design, backend implementation, OpenAPI, TypeSpec, FastAPI, and integrations. |
...
| [`dev-workflow`](./dev-workflow/) | 34 | Git, GitHub, CLI tooling, release workflows, local automation, and developer productivity. |
