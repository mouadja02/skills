...
Load the HTML template from this skill's installed directory:

```bash
<installed-skill-dir>/templates/template.html
```
...
template = Path("<installed-skill-dir>/templates/template.html").read_text(encoding="utf-8")
...
```bash
<installed-skill-dir>/examples/<filename>
```
...
Imported from NousResearch Hermes Agent optional skills (optional-skills/creative/concept-diagrams) under the MIT license. Source: https://github.com/NousResearch/hermes-agent/tree/main/optional-skills/creative/concept-diagrams
