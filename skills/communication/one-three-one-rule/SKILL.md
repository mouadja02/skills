...
Imported from NousResearch Hermes Agent optional skills (optional-skills/communication/one-three-one-rule) under the MIT license. Source: https://github.com/NousResearch/hermes-agent/tree/main/optional-skills/communication/one-three-one-rule
